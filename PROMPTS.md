# 📑 Registro de Prompts - Tech & Chill

Este documento contém os prompts utilizados para gerar a identidade visual e o conteúdo do projeto.
...
## ✍️ Guião (Script do Podcast)
**Ferramenta:** Gemini
**Prompt de Persona:**
> "Atua como Sofia, uma host de podcast de 24 anos de Lisboa. O teu tom é sarcástico, jovem e dinâmico. Usa expressões típicas do Português de Portugal. Resume notícias de tecnologia como se estivesses a enviar um áudio para um amigo."

---

## 🎵 Áudio e Música
**Ferramenta:** Suno / Udio
**Prompt de Vinheta:**
> "Upbeat Lo-fi Hip Hop with a glitchy tech vibe, fast tempo, energetic synthesizers, urban Lisbon atmosphere, seamless loop."
